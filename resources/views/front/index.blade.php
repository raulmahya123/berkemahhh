    ...
    <body class="text-black font-poppins pt-10 pb-[50px]">
        ...
        >
            ...
            <div class="flex flex-col items-center gap-[30px]">
                ...
                >
                    <div class="w-[100px] h-[48px] flex shrink-0">
                        ...
                        class="object-contain" alt="icon"> <img src={{
            ...
            <div class="flex gap-[70px] items-center justify-center">
                <div>
                    <img src={{ asset("assets/icon/logo5.png") }} alt="icon"
                    style="width: 100px;">
                </div>
                <div>
                    <img src={{ asset("assets/icon/logo1.png") }} alt="icon"
                    style="width: 100px;">
                </div>
                <div>
                    <img src={{ asset("assets/icon/logo2.png") }} alt="icon"
                    style="width: 100px;">
                </div>
                <div>
                    <img src={{ asset("assets/icon/logo3.png") }} alt="icon"
                    style="width: 100px;">
                </div>
                <div>
                    <img src={{ asset("assets/icon/logo4.png") }} alt="icon"
                    style="width: 100px;">
                </div>
            </div>
        </div>
        ...
        >
            ...
            <div class="grid grid-cols-4 gap-[30px]">
                @guest @foreach ($categories as $key => $category) @if ($key <=
                3)
                <a
                    href="/categoryWithoutAuth/{{ $category->slug }}"
                ...
                @endif @endforeach @endguest
                <!-- batas -->
                @auth @foreach ($categories as $key => $category) @if ($key <=
                3)
                <a
        ...
        >
            ...
            <div class="relative">
                <button
                    class="btn-prev absolute rotate-180 -left-[52px] top-[216px]"
                >
                    <img src={{ asset("assets/icon/arrow-right.svg") }}
                    alt="icon">
                </button>
                ...
                <div id="course-slider" class="w-full">
                    ...
                    <div class="course-card w-1/3 px-3 pb-[70px] mt-[2px]">
                        ...
                        >
                            <a
                                href="/details/{{ $course->category_id }}/{{ $course->slug }}"
                    ...
                    @empty
                    <div
                        class="alert alert-info custom-alert text-center"
                        role="alert"
                    >
        ...
        >
            <div class="relative">
                <div class="w-[355px] h-[488px]">
                    <img src={{
                        asset("assets/background/benefit_illustration_man.png")
                    }}
                    alt="icon">
                </div>
                <div
                ...
                >
                    ...
                    <div class="flex gap-2 items-center">
                        <div>
                            <img src={{ asset("assets/icon/video-play.svg") }}
                            alt="icon">
                        </div>
                    ...
                    <div class="flex gap-2 items-center">
                        <div>
                            <img src={{
                                asset("assets/icon/note-favorite.svg")
                            }}
                            alt="icon">
                        </div>
                    ...
                    <div class="flex gap-2 items-center">
                        <div>
                            <img src={{ asset("assets/icon/3dcube.svg") }}
                            alt="icon">
                        </div>
                    ...
                    <div class="flex gap-2 items-center">
                        <div>
                            <img src={{ asset("assets/icon/award.svg") }}
                            alt="icon">
                        </div>
                    ...
                    <div class="flex gap-2 items-center">
                        <div>
                            <img src={{ asset("assets/icon/book.svg") }}
                            alt="icon">
                        </div>

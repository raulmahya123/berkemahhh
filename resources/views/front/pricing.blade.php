...
<html>
    ...
    <body class="text-black font-poppins pt-10 pb-[50px]">
        ...
        <section
            class="max-w-[1100px] w-full mx-auto absolute -translate-x-1/2 left-1/2 top-[170px]"
        >
            <div class="flex flex-col gap-[30px] items-center">
                ...
                >
                    <div>
                        <img
                            src="{{ asset('assets/icon/medal-star.svg') }}"
                            alt="ikon"
                        />
                    </div>
                    <p class="font-medium text-sm text-[#FF6129]">
                        Harga Lebih Baik Untuk Anda
                    </p>
                </div>
                <div class="flex flex-col text-white text-center">
                    <h2 class="font-bold text-[40px] leading-[60px]">
                        Investasi & Dapatkan Pengembalian Lebih Besar
                    </h2>
                    <p class="text-lg -tracking-[2%]">
                        Menguasai keterampilan yang dibutuhkan dan karier dengan
                        gaji tinggi tahun ini
                    </p>
                </div>
                <div class="max-w-[1000px] w-full flex gap-[30px]">
                    <!-- <div
                        class="flex flex-col rounded-3xl p-8 gap-[30px] bg-white h-fit"
                    >
                        <div class="flex flex-col gap-5">
                            <div class="flex flex-col gap-4">
                                <p
                                    class="font-semibold text-4xl leading-[54px]"
                                >
                                    Beasiswa
                                </p>
                                <p class="text-[#475466] text-lg">
                                    Akses ke beberapa kursus online yang
                                    membantu Anda memulai jalur karir baru Anda
                                </p>
                            </div>
                            ...
                            <div class="flex flex-col gap-4">
                                <div class="flex gap-3">
                                    ...
                                    <p class="text-[#475466]">
                                        Akses semua materi kursus termasuk
                                        video, dokumen, panduan karir, dll.
                                    </p>
                                </div>
                                <div class="flex gap-3">
                                    <div class="w-6 h-6 flex shrink-0">
                                    ...
                                    <p class="text-[#475466]">
                                        Unlock semua lencana kursus untuk
                                        meningkatkan profil karir untuk melamar
                        ...
                        <a
                            href=""
                            class="p-[20px_32px] rounded-full text-center font-semibold text-xl ring-1 ring-black transition-all duration-300 hover:ring-2 hover:ring-[#FF6129]"
                            >Minta Akses</a
                        >
                    </div> -->
                    ...
                    >
                        <div class="flex flex-col gap-5">
                            ...
                            <div class="flex flex-col gap-1">
                                <p
                                    class="font-semibold text-4xl leading-[54px] price"
                                >
                                    {{ $paket->getFormattedPrice() }}
                                </p>
                            </div>
                            <div class="flex flex-col gap-4">
                                <?php if ($paket->keypointPakets->isNotEmpty()):
                                ?>
                                <?php foreach ($paket->keypointPakets as
                                $keypointPaket): ?>
                                <div class="flex gap-3">
                                    <div class="w-6 h-6 flex shrink-0">
                                        <img
                                ...
                                <?php endforeach; ?>
                                <?php else: ?>
                                <p>Tidak ada keypoint untuk paket ini.</p>
                                <?php endif; ?>
                            </div>
                        </div>
                        @if($transaction && $transaction->status == "success"
                        &&$transaction->paket_id == $paket->id)
                        <button
                            type="submit"
            ...
            <div class="flex flex-col gap-[30px] items-center text-center">
                ...
                <div class="flex flex-col">
                    ...
                    <p class="text-[#6D7786] text-lg -tracking-[2%]">
                        Mendapatkan keterampilan dan karier dengan gaji tinggi
        ...
        <section
            id="FAQ"
            class="max-w-[1200px] mx-auto flex flex-col py-[70px] px-[100px]"
        >
            <div class="flex justify-between items-center">
                <div class="flex flex-col gap-[30px]">
                    ...
                    <a
                        href="https://wa.me/62881023806530"
                ...
                <div class="flex flex-col gap-[30px] w-[552px] shrink-0">
                    ...
                    >
                        ...
                        >
                            <span class="font-semibold text-lg text-left"
                                >Apakah pemula bisa bergabung dengan
                                kursus?</span
                            >
                    ...
                    >
                        ...
                        >
                            <span class="font-semibold text-lg text-left"
                                >Apakah Anda menyediakan program jaminan
                                pekerjaan?</span
                            >
                            <div class="arrow w-9 h-9 flex shrink-0">
                                <img src={{ asset("assets/icon/add.svg") }}
                    ...
                    >
                        ...
                        >
                            <span class="font-semibold text-lg text-left"
                                >Bagaimana cara mengeluarkan semua sertifikat
                                kursus?</span
                            >
                            <div class="arrow w-9 h-9 flex shrink-0">
                                <img src={{ asset("assets/icon/add.svg") }}
        ...
        >
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <ul class="flex flex-col gap-[14px]">
                        ...
                        <li class="flex items-center gap-[10px]">
                            <a
                                href="https://www.linkedin.com/company/berkemah/?viewAsMember=true"
                                class="text-[#6D7786]"
                                >Careers</a
                            >
                            <div
            ...
            <div
                class="w-full h-[51px] flex items-end border-t border-[#E7EEF2]"
            >

...
<body class="text-black font-poppins pt-10 pb-[50px]">
    <div style="background-image: url('{{ asset('assets/background/Hero-Banner.png') }}')" id="hero-section" class="max-w-[1200px] mx-auto w-full h-[393px] flex flex-col gap-10 pb-[50px] bg-[url('')] bg-center bg-no-repeat bg-cover rounded-[32px] overflow-hidden absolute transform -translate-x-1/2 left-1/2">
                  ...
                  <div class="group p-[12px_16px] flex items-center gap-[10px] bg-[#E9EFF3] rounded-full hover:bg-[#3525B3] transition-all duration-300">
                    ...
                    <div class="group p-[12px_16px] flex items-center gap-[10px] {{ $isActive ? 'bg-[#3525B3]' : 'bg-[#E9EFF3]'}} rounded-full hover:bg-[#3525B3] transition-all duration-300">
                      ...
                      <a href="{{ route('front.learning', [$course, 'courseVideoId' => $course_video->id]) }}">
                        <p class="font-semibold {{ $isActive ? 'text-white' : 'text-black' }} group-hover:text-white transition-all duration-300">{{ $course_video->name }}</p>
                      </a>
                    </div>
                    ...
                    @if (Auth::user()->subscribe_transactions('is_paid' == true))
                        ...
                        <form id="quiz-form"
                            ...
                            <button type="button" class="btn-custom" onclick="redirectToQuiz()">Mulai
                                Quiz</button>
                ...
                <div class="flex gap-[50px]">
                    ...
                    <div class="mentor-sidebar flex flex-col gap-[30px] w-full">
                        <div class="mentor-info bg-white flex flex-col gap-4 rounded-2xl p-5">
                         ...
                         {{-- cek certificate by user --}}


<!-- resources/views/your_view.blade.php -->
<a href="{{ route('front.certificate.index_by_user') }}" class="btn btn-primary">

...
<html>
    ...
    <body class="text-black font-poppins pt-10 pb-[50px]">
        ...
        >
            ...
            >
                <p class="mx-auto text-sm text-[#83a5da] -tracking-[2%]">
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.allCompleted) {
                            ...
                            class="flex flex-col rounded-t-[12px] rounded-b-[24px] gap-[32px] bg-white w-full pb-[10px] overflow-hidden ring-1 ring-[#DADEE4] transition-all duration-300 hover:ring-2 hover:ring-[#FF6129]"
                        >
                            <a href="/psikotest" class="px-2 py-4 bg-orange-600"
                                >Psikotest</a
                            >
                    ...
                    error: function (jqXHR, textStatus, errorThrown) {
                        console.log(
                            "Error fetching button psikotest:",
                            jqXHR.responseText
                        );
                    },
                });
